...
function LandingPage() {
  ...
  return (
    <div className="flex flex-col">
      <div className="relative h-screen w-full bg-[radial-gradient(circle_at_center,_rgba(255,255,255,1)_0%,_rgba(27,135,45,0.2)_100%)] overflow-y-auto p-4 flex flex-col">
      ...
      <div className="relative h-screen w-full bg-[radial-gradient(circle_at_center,_rgba(255,255,255,1)_0%,_rgba(27,135,45,0.2)_100%)] overflow-y-auto p-4 flex flex-col">
        <h1 className="text-4xl font-bold text-[rgb(27,135,45)] opacity-50 w-full text-center text-[4rem] sm:text-[6rem] md:text-[8rem] p-6">Meet the Team</h1>
        {/* Card Grid */}
